...
<head>
    ...
    <style type="text/css">
        ...
        #addressArea div a:link,
        #addressArea div a:visited {
            color: #404040;
            font-weight: normal;
            text-decoration: underline;
            font-family: Open Sans, Arial;
            ...
            <tr>
                <td align="center" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;background: white;" id="templateContainer">
                        <tr>
                            <td align="center" valign="top">
                                <img align="none" src="https://gallery.mailchimp.com/889f464a532f32aaee68a2e7c/images/390afc9c-89ed-4c2f-9b3b-90a78071cc1f.png" style="width: 100%;max-width: 600px;border: none;height: auto;line-height: 100%;outline: none;text-decoration: none;font-size: 14px;font-weight: bold;text-transform: capitalize;">
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
                                    ...
                                    <tr>
                                        <td valign="top" class="bodyContent" style="background-color: #fff;">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <div class="bodyContentArea" style="margin: 50px 20px 0px 20px;padding-bottom: 30px;color: #000;font-family: Open Sans,Arial;font-size: 12px;line-height: 150%;text-align: left;border-bottom: 1px solid #EBEBEB;">Dear Really Good Emails,
                                                            <br>
                                                            <br>Just dropping in to let you know we'll be shutting down our engines for scheduled maintenance on Tuesday the 12th of July between 7:00 and 9:00 GMT.
                                                            <br>
                                                            <br>We apologize for any inconvenience this may cause, but even a well-oiled machine needs to be serviced from time to time.
                                                            <br>
                                                            <br>On the bright side, we'll be back bigger, better and stronger than before.
                                                            <br>
                                                            <br>
                                                            <br>Thanks,
                                                            <br>
                                                            <br> <span class="h4" style="color: #000;display: block;font-family: Open Sans,Arial;font-size: 14px;font-weight: bold;line-height: 100%;margin-bottom: 10px;text-align: left;">- The Proto.io Team -</span>
                                            ...
                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                <tr>
                                                    <td valign="middle" id="learnMore" style="background-color: #fff;color: #000;">
                                                        <div style="color: #000;font-family: Open Sans, Arial;font-size: 10px;line-height: 165%;text-align: center;">Looking for more resources? Visit our
                                                            <a href="https://proto.io/en/learn/?utm_source=Maintenance-0707&utm_campaign=7719cdaae3-Proto_io_Scheduled_Maintenance&utm_medium=email&utm_term=0_791617aea2-7719cdaae3-361329825" style="color: #00A1C0;font-weight: normal;text-decoration: underline;">Learn</a> page.
                                                            Want to get inspired? Check out Proto.io
                                                            <a href="https://spaces.proto.io/?utm_source=Maintenance-0707&utm_campaign=7719cdaae3-Proto_io_Scheduled_Maintenance&utm_medium=email&utm_term=0_791617aea2-7719cdaae3-361329825" style="color: #00A1C0;font-weight: normal;text-decoration: underline;">Spaces</a>.
                                                            <br>How about viewing prototypes on your mobile device? Get our Proto.io Player App for
                                                            <a href="https://itunes.apple.com/app/proto.io-player/id854504039?utm_source=Maintenance-0707&utm_campaign=7719cdaae3-Proto_io_Scheduled_Maintenance&utm_medium=email&utm_term=0_791617aea2-7719cdaae3-361329825" style="color: #00A1C0;font-weight: normal;text-decoration: underline;">iOS</a> and
                                                            <a href="https://play.google.com/store/apps/details?id=io.proto.player&utm_source=Maintenance-0707&utm_campaign=7719cdaae3-Proto_io_Scheduled_Maintenance&utm_medium=email&utm_term=0_791617aea2-7719cdaae3-361329825" style="color: #00A1C0;font-weight: normal;text-decoration: underline;">Android</a>.
                                                            Have questions? Contact one of our
                                                            <a href="https://protoio.zendesk.com/anonymous_requests/new?utm_source=Maintenance-0707&utm_campaign=7719cdaae3-Proto_io_Scheduled_Maintenance&utm_medium=email&utm_term=0_791617aea2-7719cdaae3-361329825" style="color: #00A1C0;font-weight: normal;text-decoration: underline;">Proto.io experts</a>,
                                                            they're a jolly old bunch always willing to lend a helping hand (or two)!
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td valign="top" id="addressArea" style="border-top: 1px solid #F5F5F5;background: #f2f2f2;">
                                                        <div style="color: #606060;font-family: Open Sans, Arial;font-size: 10px;line-height: 165%;text-align: center;">This email was sent to xxxxxxxx@xxxx.xxx
                                                            <br>You got this because you have registered at Proto.io,
                                                            <a href="#" style="color: #404040;font-weight: normal;text-decoration: underline;font-family: Open Sans,Arial;">unsubscribe from this list</a>
                                                            <br>Proto.io, Inc · 156 2nd street. · San Francisco, CA 94105 · USA
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td valign="top" class="bodyContent" style="background-color: #fff;">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <div class="bodyContentArea" style="margin: 50px 20px 0px 20px;padding-bottom: 30px;color: #1b84ff;font-family: Open Sans,Arial;font-size: 20px;line-height: 150%;text-align: left;border-bottom: 1px solid #EBEBEB;"> New Message in Ticket #<?= $ticket_id ?> from <?= $username ?>,
                                                            <br>
                                                            <p><?= $message ?></p>.
                                                            <br>
                                                            <span class="h4" style="color: #000;display: block;font-family: Open Sans,Arial;font-size: 14px;font-weight: bold;line-height: 100%;margin-bottom: 10px;text-align: left;">- New Message -</span>
