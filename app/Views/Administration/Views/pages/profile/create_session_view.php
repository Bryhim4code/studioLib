            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Create Sessions</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                ...
                                <div class="card-body pt-5">
                                    <!--begin::Form-->
                                    <form id="kt_ecommerce_settings_general_form" class="form" action="<?= base_url() . (isset($mode) && $mode === 'edit' ? 'admin/session/edit/' . $Id : 'admin/session/create') ?>" method="post">
                                        <!-- Title -->
                                        ...
                                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                            <div class="col">
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="date" class="form-control form-control-solid" name="session_start" value="<?= isset($session['session_start']) ? $session['session_start'] : '' ?>" required />
                                            ...
                                            <div class="col">
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="date" class="form-control form-control-solid" name="session_end" value="<?= isset($session['session_end']) ? $session['session_end'] : '' ?>" required />
                                        ...
                                        <div class="fv-row mb-7">
                                            <label class="fs-6 fw-semibold form-label mt-3">
                                                <span>Notes</span>
                                                <span class="ms-1" data-bs-toggle="tooltip" title="Enter any additional notes about the session (optional).">
                                                    <i class="ki-duotone ki-information fs-7">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                        <span class="path3"></span>
                                            ...
                                            <textarea class="form-control form-control-solid" name="session_description" required><?= isset($session['session_description']) ? $session['session_description'] : '' ?></textarea>
