                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <!-- <th class="min-w-130px">School</th> -->
                                        <th class="min-w-135px">KYC Status </th>
                                        <th class="min-w-130px">Phone</th>
                                        <th class="min-w-100px">Course</th>
                                        <th class="min-w-100px">level</th>
                                        <th class="min-w-100px">Agreement Sent</th>
                                        <th class="min-w-100px">Date/Time </th>
                                        <th class="text-end min-w-70px">Actions</th>
                                    </tr>
                                </thead>
                                <tbody class="fw-semibold text-gray-600">
                                    <?php if (isset($Residentslist) && is_array($Residentslist)) : ?>
                                    <?php foreach ($Residentslist as $data) : ?>
                                    <tr>
                                        <td>
                                        ...
                                        <!-- <td>
                                            <a
                                                class="text-gray-600 text-hover-primary mb-1"></?= isset($data['school']) ? $data['school'] : '' ?></a>
                                        </td> -->
                                        <td>
                                        <div
                                                class="badge <?= isset($data['kyc_status']) && $data['kyc_status'] == 'DENIED' ? 'badge-light-danger' : 'badge-success' ?>">
                                                <?php
                                                        // Check if room_status is CHECKEDIN or NOTIN and display accordingly
                                                        if (isset($data['kyc_status'])) {
                                                            if ($data['kyc_status'] == 'APRROVED') {
                                                                echo 'KYC Approved';
                                                            } elseif ($data['kyc_status'] == 'DENIED') {
                                                                echo 'KYC Denied';
                                                            } else {
                                                                echo $data['kyc_status'];
                                                            }
                                                        }
                                                        ?>
                                            </div>    
                                        ...
                                        <td>
                                            <a
                                                class="text-gray-600 text-hover-primary mb-1"><?= isset($data['course']) ? $data['course'] : '' ?></a>
                                        </td>
                                        <td>
                                                    <a
                                                        class="text-gray-600 text-hover-primary mb-1"><?= isset($data['level']) ? $data['level'] : '' ?></a>
                                                </td>


                                        <td>
                                            <div
                                                class="badge <?= isset($data['agreement']) && $data['agreement'] == 'NO' ? 'badge-light-danger' : 'badge-success' ?>">
                                                <?php
                                                        if (isset($data['agreement'])) {
                                                            if ($data['agreement'] == 'YES') {
                                                                echo 'Agreement Sent';
                                                            } elseif ($data['agreement'] == 'NO') {
                                        ...
                                        <td>
                                                    <a
                                                        class="text-gray-600 text-hover-primary mb-1"><?= isset($data['updated_at']) ? $data['updated_at'] : '' ?></a>
                                                </td>
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="<?= base_url() . 'admin/residents/details/view/' . $data['id'] ?>"
