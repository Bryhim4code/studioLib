                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        ...
                                        <div class="w-200px me-3">
                                            <!--begin::Select2-->
                                            <a href="<?= base_url('admin/announcements/create') ?>"> <button class="btn btn-primary">Create Announcement</button></a>
                                        ...
                                        <?php if (isset($announcements) && is_array($announcements)) : ?>
                                            <?php foreach ($announcements  as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="text-gray-800 text-hover-primary mb-1"><?= isset($data['title']) ? $data['title'] : '' ?>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a class="text-gray-600 text-hover-primary mb-1"><?= isset($data['message']) ? $data['message'] : '' ?></a>
                                                    </td>
                                                    <td>
                                                        <a class="text-gray-600 text-hover-primary mb-1"><?= isset($data['start_date']) ? $data['start_date'] : '' ?></a>
                                                    </td>
                                                    <td>
                                                        <a class="text-gray-600 text-hover-primary mb-1"><?= isset($data['end_date']) ? $data['end_date'] : '' ?></a>
                                                    </td>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="<?= base_url('admin/announcements/edit/' . $data['id']) ?>" class="menu-link px-3">Edit</a>
                                                            </div>
                                                            <div class="menu-item px-3">
                                                                <a href="<?= base_url('admin/announcements/delete/' . $data['id']) ?>" class="menu-link px-3">Delete</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
