  ...
  <div>
    ...
    <section class="py-5 p-20 auth-sec text-center">
      <div class="container mt-40 mb-20 text-center">
        ...
        <!-- Sign Up Form -->
        <form action="<?= base_url() . 'studio-registration' ?>" method="post" id="signInForm" class="form-box" autocomplete="off">
          <h5 class="p-5 fw-medium fs-5">Sign Up</h5>
          <div class="mb-3 auth text-start mb-4">
            <label class="text-start mb-2" for="Username">User Name <span class="text-purple">( Artist Name )</span></label>
            <input name="username" type="text" class="form-control mb-3" placeholder="Enter your Username" autocomplete="off">
          </div>
          <div class="mb-3 auth text-start mb-4">
          ...
          <div class="mb-3 auth text-start mb-4 position-relative">
            ...
            <span class="position-absolute top-50 end-0 translate-middle-y mt-4 p-3 pe-3" onclick="togglePassword('passwordSignIn', 'togglePasswordIconSignIn')" style="cursor: pointer;">
          ...
          <button class="btn btn-purple rounded-pill w-100 mb-2 mt-3">Sign Up</button>
          <!-- <button class="btn btn-outline-dark rounded-pill w-100">Continue with Google</button> -->
          <p class="mt-3 text-muted">Already have an account? <a class="text-purple fw-medium" href="<?= base_url()?>auth">Sign in</a></p>
         </form>

        <!-- Sign Up Form -->
        <form action="<?= base_url() . 'studio-registration' ?>" method="post" id="signUpForm" class="d-none form-box" autocomplete="off">
          <h5 class="p-5 fw-medium fs-5">Sign Up</h5>
          <div class="mb-3 auth text-start mb-4">
            <label class="text-start mb-2" for="Username">User Name <span class="text-purple">( Studio Name )</span></label>
            <input name="username" type="text" class="form-control mb-3" placeholder="Enter your Username">
          </div>
          <div class="mb-3 auth text-start mb-4">
            <label class="text-start  mb-2" for="Email">Email Address</label>
            <input name="email" type="email" class="form-control mb-3" placeholder="Enter your email">
