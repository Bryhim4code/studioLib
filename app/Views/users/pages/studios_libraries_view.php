        ...
        <div class="row g-4 mt-10">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card border-0 rounded-4 shadow-sm h-100">
              ...
              <div class="card-body">
                <small class="text-muted badge goe-loc mb-1"><img src="<?= base_url()?><?= base_url()?>assets/images/icons/svgs/location.svg" alt="StudioLib studio location"></i>Kado, Abuja</small>
